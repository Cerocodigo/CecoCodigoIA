...
from core.views.onboarding.set_active_company import set_active_company_view
...
urlpatterns = [
    ...
    path("set-company/<int:company_id>/",set_active_company_view, name="set_active_company"),
